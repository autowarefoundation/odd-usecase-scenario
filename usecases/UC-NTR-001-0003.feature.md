...
Tests the case where a following vehicle overtakes at relatively high velocity in the same direction lane.
Verifies the vehicle correctly waits for the completion of the overtake and departs safely afterward.

* Given Ego is in standstill
* And Npc0 is positioned behind Ego, in the same driving lane
* And Npc0 is driving at <vx_npc0> towards Ego
...
### Examples: Npc overtakes through left lane
  ...
  | vx_npc0 | dr    | df    | overtake_offset | amin_ego   |
  | ------- | ----- | ----- | --------------- | ---------- |
